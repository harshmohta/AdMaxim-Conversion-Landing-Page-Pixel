...
{
  "displayName": "AdMaxim Conversion and Landing Page Tracking Pixel",
  "description": "Use the AdMaxim Pixel to easily track your campaign's performance. Track Conversions or Landings on website, which let you know how many times people loaded/converted your website, after clicking.",
  "securityGroups": [],
...
[
  {
    "help": "Please select Conversion pixel for tracking Conversions or Landing Pixel to track the land's on your website.",
  ...
  {
    "help": "Please specify comma-separated Campaign ID.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      },
...
Created on 29/08/2019, 14:28:13
